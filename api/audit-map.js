export default async function handler(req, res) {
  ...
  let systemPrompt = `You are a senior AI automation consultant at Pellucen, a Manchester-based company that builds AI workflow tools for small businesses. The user will describe a business workflow. Parse it into discrete steps and analyse which can be automated.
